...
class CustomApp extends next_app__WEBPACK_IMPORTED_MODULE_2___default.a {
  static async getInitialProps(appContext) {
    const mobxStores = Object(_store_store__WEBPACK_IMPORTED_MODULE_4__["getStores"])(); //make stores available to all pages

    appContext.ctx.mobxStore = mobxStores; //call super to run pages

    const appProps = await next_app__WEBPACK_IMPORTED_MODULE_2___default.a.getInitialProps(appContext); //gather serialization friendly data from store
  ...
  render() {
    ...
    const stores = Object(_store_store__WEBPACK_IMPORTED_MODULE_4__["getStores"])(initialData);
    return __jsx(_store_store__WEBPACK_IMPORTED_MODULE_4__["StoreProvider"], {
      value: stores,
      __self: this,
      __source: {
